...
IS
    ...
    BEGIN
        ...
        (BICYCLE_ID, BICYCLE_STATUS_TIMESTAMP, BICYCLE_STATUS_LATITUDE, BICYCLE_STATUS_LONGITUDE, BICYCLE_STATUS)
        VALUES
        (p_bicycle_id, lv_final_date, p_latitude, p_longitude, p_status);
