...
<div class="container-fluid" id="main">
    <div class="row row-offcanvas row-offcanvas-left">
        <div class="col-md-3 col-lg-2 sidebar-offcanvas bg-dark p-0" id="sidebar" role="navigation">
            <ul class="nav flex-column sticky-top pl-0 pt-5 mt-1">
                <li class="nav-item"><button type="button" id="ansatte" class="btn btn-dark w-100">Ansatte</button></li>
                <li class="nav-item"><button type="button" id="utstyr" class="btn btn-dark w-100">Utsyr</button></li>
                <li class="nav-item"><button type="button" id="rapporter" class="btn btn-dark w-100">Rapporter</button></li>

            </ul>
        </div>
        <!--/col-->

        <div id="home-section" class="col main pt-5 mt-3">
...
<div id="ansatte-list" class="row hidden">
<ul>
...
<div id="ansatte-form" class="content-section hidden">
