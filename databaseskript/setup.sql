...
(
    ...
    constraint rent_end_rent_date_uindex
        unique (end_rent_date),
    constraint rent_start_rent_date_uindex
        unique (start_rent_date),
    constraint Rent_equipment_id_5b98b270_fk_Equipment_id
        foreign key (equipment_id) references `equipment category` (id),
